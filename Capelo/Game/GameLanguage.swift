...
enum GameLanguage: String, CaseIterable, Codable {
    ...
    var distribution: [(Character, Int)] {
        switch self {
        case .french:
            [("E",19),("A",13),("I",11),("S",8),("N",7),("R",7),("T",7),("O",9),("U",9),("L",6),("D",4),("C",3),("M",3),("P",3),("G",2),("B",2),("F",2),("H",2),("V",2),("J",1),("Q",1),("K",1),("W",1),("X",1),("Y",1),("Z",1)]
        case .english:
            [("E",16),("A",12),("I",11),("O",10),("N",6),("R",6),("T",6),("L",4),("S",4),("U",7),("D",4),("G",3),("B",2),("C",2),("M",2),("P",2),("F",2),("H",2),("V",2),("W",2),("Y",2),("K",1),("J",1),("X",1),("Q",1),("Z",1)]
        case .spanish:
            [("A",16),("E",16),("O",12),("S",6),("I",9),("N",5),("R",5),("U",8),("L",4),("T",4),("D",5),("C",4),("G",2),("B",2),("M",2),("P",2),("H",2),("F",1),("V",1),("Y",1),("Q",1),("J",1),("X",1),("Z",1)]
        case .portuguese:
            [("A",18),("E",15),("I",13),("O",13),("S",8),("U",10),("M",6),("R",6),("T",5),("D",5),("L",5),("C",4),("P",4),("N",4),("B",3),("F",2),("G",2),("H",2),("V",2),("J",2),("Q",1),("X",1),("Z",1)]
        }
    }
